...
different properties (cross-family $r = 0.14$--$0.62$, versus within-family
$r > 0.74$), and that rank instability is predictable from binding profile shape.
...
satisfy, show that no existing definition satisfies all four, and propose a
measure that does and recovers its full-panel ranking from about half a panel.
\end{abstract}

\noindent\textbf{Keywords:} binding affinities, binding selectivity,
