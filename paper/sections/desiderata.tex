...
panel ($p^* = 343$).
It converges as fast as the bare entropy, so the D1 gate and the smooth emphasis
cost nothing in panel recoverability while adding the two properties the entropy
lacks.
...
\begin{figure}[h]
  ...
  \caption{Panel-size convergence of the candidate measure compared with the
           ...
           The candidate converges in the fast regime ($p^* = 110$),
           matching the entropy, ahead of the S-score, and well ahead of the Gini
           and ratio.}
  \label{fig:candidate}
\end{figure}
