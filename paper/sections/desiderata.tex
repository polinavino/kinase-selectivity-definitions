...
The empirical findings of Section~\ref{sec:results} motivate four properties
...
32$ for active compounds (Section~\ref{sec:results:taxonomy}, Type~1).
...
Section~\ref{sec:results:taxonomy}, where top$_1$--top$_2$ gap is the
