...
\begin{figure}[h]
  ...
  \caption{Representative binding profiles illustrating the three instability types.
           ...
           including two near-tied top targets ($\Delta\mathrm{p}K_d = 0.024$).
...
When a compound's two best-bound kinases have near-identical affinities, the
...
Drug~23 in the Davis dataset (top$_1$--top$_2$ gap $= 0.024$~pKd units) is the
