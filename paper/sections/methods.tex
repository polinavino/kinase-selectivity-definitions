...
matrix and 3.6\% of the Klaeger matrix. Weaker interactions that fall below the
limit of detection are recorded at the background value.
...
\begin{figure}[htbp]
  ...
  \caption{Operationalization sensitivity of the entropy and Gini coefficient.
           ...
           confirming that the operationalization of a named metric is itself a
           source of the definitional instability we report.}
  \label{fig:fidelity}
\end{figure}
