...
All scientific conclusions, the conceptual framework, the properties proposed in the
Motivated Properties section, and the final manuscript content were developed, verified, and
...
secondary clinical-outcome analysis (FAERS adverse-event report rates,
obtained via openFDA queries, and FDA-label discontinuation rates, from FDA
product labels, for the FDA-approved Klaeger compounds).
